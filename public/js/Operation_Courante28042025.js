...
function activerOnglet(tab) {
  ...
  // Ajouter les lignes de code pour déboguer
  console.log('Onglet sélectionné :', tabId);
  console.log('Données pour l\'onglet :', data); // vous devez définir la variable data avant de la logger
  console.log('Tableau Tabulator :', tableOP);
}
...
// 2) Mapping Excel → fields Tabulator
const headerMap = {
    "Date":                "date",
