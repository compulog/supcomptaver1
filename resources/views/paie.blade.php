...
<span style="color:rgb(34, 146, 245); text-decoration: underline; font-weight: bold;">➢Paie</span></h6>
...
<!-- 💬 Modal Fusionner (identique achat.blade.php) -->
...
<style>
  /* Pas de style CSS pour #fileOrderModal ici, tout est inline comme dans achat.blade.php */
</style>
...
//         return; // Ne pas continuer si le tableau est vide
//     }
...
//         currentFileIndex = 0; // Ne pas aller en arrière
//     } else if (currentFileIndex >= files.length) {
//         currentFileIndex = files.length - 1; // Ne pas aller au-delà
//     }

//     console.log(currentFileIndex); // Vérifiez l'index courant
//     console.log(files); // Vérifiez le contenu du tableau

//     // Chargez le fichier suivant en appelant viewFile avec l'ID du fichier
//     viewFile(files[currentFileIndex].id);
// }
