...
.form-select {
   ...
   <span style="color:rgb(34, 146, 245); text-decoration: underline; font-weight: bold;">➢</span> 
    <a href="{{ route('vente.view') }}"  style="color:rgb(34, 146, 245); text-decoration: underline; font-weight: bold;">Vente</a>
 <span  style="color:rgb(34, 146, 245); text-decoration: underline; font-weight: bold;">➢</span> 
    @php
...
function openFile(folderId) {
    // Récupérer l'ID de la société depuis une variable Blade injectée
    ...
    // Rediriger avec societeId dans l'URL
