...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.11/jspdf.plugin.autotable.min.js"></script>
<!-- SheetJS pour parser l’Excel côté client -->
...
<body>
        ...
        <div class="tabs">
        <div class="tab" data-tab="Achat"  class="border rounded p-3 mt-2 bg-white shadow-sm">Achats</div>
        <div class="tab" data-tab="Ventes" class="border rounded p-3 mt-2 bg-white shadow-sm">Ventes</div>
        ...
        <div class="tab" data-tab="Operations-Diverses"  class="border rounded p-3 mt-2 bg-white shadow-sm">Opérations Diverses</div>
...
<div style="display: flex; align-items: center; gap: 12px; border: 1px solid #ddd; padding: 6px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);">
  ...
  />
            ...
            <button class="icon-button border-0 bg-transparent" id="delete-row-btnAch" title="Supprimer">
...
<div style="display: flex; align-items: center; gap: 12px; border: 1px solid #ddd; padding: 6px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);">
  ...
  <!-- Input caché pour le fichier Excel -->
  <input type="file" id="excel-file-ventes" accept=".xlsx,.xls" style="display: none;" />
            ...
            <button class="icon-button border-0 bg-transparent" id="delete-row-btnVte" title="Supprimer">
                <i class="fas fa-trash-alt text-danger" style="font-size: 14px;"></i>
            </button>
...
<div id="achats" class="tab-content active"> <!-- Tab pour Achats -->
    <div id="table-achats"></div>
</div>
<div id="Ventes" class="tab-content"> <!-- Tab pour Ventes -->
    <div id="table-ventes"></div>
</div>
<div id="Operations-Diverses" class="tab-content"> <!-- Tab pour Opérations Diverses -->
