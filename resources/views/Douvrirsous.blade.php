...
<a href="{{ route('exercices.show', ['societe_id' => session()->get('societeId')]) }}"  style="color:rgb(34, 146, 245); text-decoration: underline; font-weight: bold;">Tableau De Board</a>
   <span style="color:rgb(34, 146, 245); text-decoration: underline; font-weight: bold;"> ➢{{$folder->type_folder}}</span></h6>
...
<input type="hidden" name="exercice_fin" value="{{ $societe->exercice_social_fin }}">
                ...
                <div class="">
                    <button 
                        ...
                        aria-expanded="false"
                        style="background-color:#4D55CC;border: 1px solid white; border-radius: 10px; color: white; width: 100%;">
                        Charger
                    </button>
