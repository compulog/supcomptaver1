...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    ...
    <li class="nav-item">
      <a class="nav-link {{ (Request::is('utilisateur') ? 'active' : '') }}" href="{{ url('utilisateurs') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('plan_comptable') ? 'active' : '') }}" href="{{ url('plan_comptable') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Gestions plan comptable</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('gestion_des_journaux') ? 'active' : '') }}" href="{{ url('gestion_des_journaux') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<!-- 
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('saisie de mouvement TRESO') ? 'active' : '') }}" href="{{ url('saisie de mouvement TRESO') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('saisie de mouvement TRESO') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
    ...
    <div class="card-body text-start p-3 w-100"> 
       <div class="icon icon-shape icon-sm bg-white shadow text-center mb-3 d-flex align-items-center justify-content-center border-radius-md">
        ...
        <div class="docs-info">
          ...
          <p class="text-xs font-weight-bold">clik</p>
          <a href="/documentation/getting-started/overview.html" target="_blank" class="btn btn-white btn-sm w-100 mb-0"></a>
        </div>   
      </div>
    </div>
  </div> -->
