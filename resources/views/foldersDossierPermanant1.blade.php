...
.form-select {
    ...
    @foreach ($breadcrumbs as $index => $breadcrumb)
        @if ($index >= count($breadcrumbs) - 3)
            <a href="{{ route('folder.show', ['id' => $breadcrumb->id]) }}?breadcrumb={{ $breadcrumbTrailEncoded }}&clicked={{ urlencode($breadcrumb->name) }}&type=dossier_permanant"
...
<!-- Input caché pour fusionner -->

<!-- Input caché pour fusion Vente -->
<input type="file" id="filesToMergeDossier_permanantHidden" multiple style="display: none;" onchange="mergeFilesDossier_permanantDirect(event)">
...
function handleUploadDossier_permanant(option) {
 ...
 async function confirmOrder() {
     closeModal();
     await mergeFilesDossier_permanant(confirmOrder);
 }

 async function mergeFilesDossier_permanant(files) {
...
<div class="modal fade" id="createFolderModal" tabindex="-1" aria-labelledby="createFolderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('foldersDossierPermanant1.create') }}" method="POST">
                    @csrf
...
// ...existing code...rl = '/file/view/' + fileId;
