            ...
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="cnss" id="cnss" maxlength="15" title="Veuillez entrer un numéro CNSS valide" required>
                        </div>
        ...
        <input type="text" class="form-control" id="mod_patente" required name="patente">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="mod_cnss" id="mod_cnss" maxlength="15" title="Veuillez entrer un numéro CNSS valide" required>
                        </div>
                        <div class="col-md-4 mb-3">
