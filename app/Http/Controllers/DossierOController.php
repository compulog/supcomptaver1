...
class DossierOController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($request->has('folders_id') && $request->folders_id) {
            return redirect()->route('dossier.ouvrir', ['id' => $request->folders_id])->with('success', 'Dossier créé avec succès');
        }
    ...
    public function show($id)
    {
        ...
        return view('dossier.ouvrir', compact('dossier', 'files', 'folders'));
    }
