...
<body>
  ...
  <div class="image-container">
    <img src="../assets/img/curved-images/template 001.png" alt="Image">
    <div class="text-on-image">TELE-DÉCLARATION COMPTABILITÉ PAIE</div>
  </div>
  ...
  <div class="form-section">
    ...
    <div id="maintenanceMessage">SITE EN MAINTENANCE.</div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Empêcher la soumission si le nom est incorrect
      loginForm.addEventListener('submit', function (e) {
        const name = nameInput.value.trim();
        if (name !== 'COMPULOG_CHABAANE') {
          e.preventDefault();
