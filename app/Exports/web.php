...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/grandlivre', [GrandLivreController::class, 'index'])->name('grandlivre.index');
    Route::post('/grandlivre', [GrandLivreController::class, 'store'])->name('grandlivre.store');
Route::delete('/grandlivre/{id}', [GrandLivreController::class, 'destroy'])->name('grandlivre.destroy');
Route::get('/files', [OperationCouranteController::class, 'getFiles']);

Route::post('/import-file', [OperationCouranteController::class, 'importFile']);

Route::get('/get-plan-comptable', [OperationCouranteController::class, 'getPlanComptable']);
